...
const EmptyState = () => {
  return (
    <>
      <View className="min-h-full flex-col gap-2 items-center justify-center ">
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            <View className="mt-10 flex-col gap-1 items-start justify-center  px-5">
                ...
                <>
                  {savedMovies?.length! > 0 ? (
                    <FlatList
                      ...
                      numColumns={3}
                      columnWrapperClassName="gap-5  px-5 left-1 mb-10"
                    />
                  ) : (
                    <EmptyState />
                  )}
